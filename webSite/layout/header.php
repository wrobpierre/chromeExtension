  ...
  <div class="w3-top" style="z-index: 999;">
    <div class="w3-bar w3-red w3-card w3-left-align w3-large">
      ...
      if(isset($_SESSION['user'])){
        ?>
        <a href="/webSite/questionnaires/statistics" class="w3-bar-item w3-button w3-hide-small w3-hide-medium w3-padding-large w3-hover-white w3-left">Statistics</a>
    ...
    <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-large">
      <a href="./questionnaires/questionnaire" class="w3-bar-item w3-button w3-padding-large">List of questionnaires</a>
